...
if(nameinput.value === '' || emailUp.value === '' || passwordUp.value === '' || confirmPassword.value === '') {
...
else if(emailIn.value === localStorage.getItem('email') && passwordIn.value === localStorage.getItem('password')) {
